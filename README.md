...
Рассмотрим в качестве типов: скаляры, вектора и матрица. Ну и значения им сооветствующие.
...
При этом в случае, если переменной сопоставлен ожидаемый тип, то подставнока может быть неудачной, если тип подставляемого не совпадает.
...
Я в текущей реализации я пошел простым путем и запретил, т.к. это просто быстрее. Второй вариант тоже можно реализовать. Но конечно более красивым было бы добавить в тип вектора и матрица их значения.
